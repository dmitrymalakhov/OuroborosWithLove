...
| Presentation workflows | `create_presentation`, `inspect_presentation_for_edit`, `edit_presentation`, `convert_pptx_to_pdf` | Generate new PowerPoint `.pptx` decks, inspect and edit an existing presentation copy in place while preserving source package objects, and export PPTX decks to PDF for Telegram delivery. |
